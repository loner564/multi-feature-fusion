...
matrix = np.array([
    ...
    [0, 0, 0, 'P1', 'PZ', 'P2', 0, 0, 0],
    [0, 0, 0, 'PO3', 'POZ', 'PO4', 0, 0, 0],
...
# 设置大文件夹路径和新大文件夹路径
folder_path = "F:/SEED-VIG数据集/10.加通道列/1"
new_folder_path = "F:/SEED-VIG数据集/11.映射/1"
        ...
        if filename.endswith(".csv"):
            ...
            for channel_name in data_csv['channels']:
                if channel_name in channel_map:
                    ...
                    data_value = data_csv.loc[data_csv['channels'] == channel_name, 'DE'].iloc[0]
